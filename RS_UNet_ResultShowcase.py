...
def case_study_display(data_config, model_config, train_config,
    ...
    model = UNet(channel_list=model_config.get("channel_list"),
...
if __name__ == '__main__':
    config_file = './config/RS_Unet_config.yml'
    showcase_stored_folder = './ExperimentImages/RS_UNet'
    ...
    case_study_display(data_config=data_config, train_config=train_config,
                       model_config=model_config, sample_number=6, epoch=122,
